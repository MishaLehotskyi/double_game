        ...
        <div className={"flex flex-col justify-center items-center md:gap-[30px] gap-[15px]"}>
          ...
          <div
            ...
            {tickets.length > 0 && tickets.map((ticket, index) => (
              <div key={ticket.id} className={`flex justify-center text-[15px] md:text-[20px] gap-[15px] ${user?.metamaskId && ticket.metamaskId.toLowerCase() === user.metamaskId.toLowerCase() ? 'bg-green-600 rounded-2xl px-[5px]' : ''}`}>
