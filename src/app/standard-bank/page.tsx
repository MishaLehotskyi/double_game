      ...
      <div
        ...
        <div className={"flex md:justify-evenly justify-between items-center w-full px-[15px]"}>
          <div className={"flex flex-col justify-center items-center gap-[10px]"}>
            <p>Учасники</p>
            <p className="text-[60px] font-bold border border-green-600 rounded-2xl md:px-[15px] px-[5px] min-w-[80px] text-center">10</p>
          </div>
          ...
          <div className={"flex flex-col justify-center items-center gap-[10px]"}>
            ...
            <p className="text-[60px] font-bold border border-green-600 rounded-2xl md:px-[15px] px-[5px] min-w-[80px] text-center">5</p>
          </div>
        </div>
