      ...
      <div
        ...
        <div className={"flex justify-center absolute top-[-30px] bg-[#2a2a2a] border border-yellow-600 rounded-full shadow-[0_0_20px_5px_rgba(255,215,0,0.5)] bg-yellow-600"}>
          ...
          <Tooltip
            open={open}
            onClick={handleClick}
            title={"Для участия в лорее Mega Bank переведите 500 токенов DBE на адрес 0x740B45a8E7C01AAFC6CD823e5a794F172eE9cCD0 Сеть BSC. После этого вы автоматически появитесь в окне участников с присвоенным номером билета"}
